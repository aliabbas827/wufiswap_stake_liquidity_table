   ...
   return (
      <>
        <TableRow className="bg-[#36373a] w-full ">
            ...
            <div>
            <h1 className='text-xl'>Enter Amount</h1>
            <input type="number" className=" bg-[#5a5d60] text-xl appearance-none border-0 focus:outline-none w-[100%] py-2 px-5 mt-3 rounded-[30px]" placeholder='0 LP' />
            </div>
